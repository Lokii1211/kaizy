    ...
    <div className="min-h-screen pb-24" style={{ background: "var(--bg-app)" }}>
      ...
      {step === "info" && (
        <div className="px-5">
          ...
          {/* Grace period notice */}
          <div className="rounded-[20px] p-5 mb-4" style={{ background: "var(--bg-card)", border: "1px solid rgba(255,107,0,0.2)" }}>
            ...
            <p className="text-[12px] font-medium" style={{ color: "var(--text-2)" }}>
              After you submit a deletion request, your account will be deactivated immediately but your data will be retained for <strong>30 days</strong>. During this period, you can log back in to cancel the deletion. After 30 days, all personal data will be permanently and irreversibly deleted.
            </p>
          </div>

          {/* Download data — DPDP Act right to data portability */}
          <div className="rounded-[20px] p-5 mb-4" style={{ background: "var(--bg-card)" }}>
            <p className="text-[11px] font-bold uppercase tracking-widest mb-2" style={{ color: "var(--text-3)" }}>
              Download Your Data
            </p>
            <p className="text-[12px] font-medium mb-3" style={{ color: "var(--text-3)" }}>
              As per the DPDP Act 2023, you have the right to download a copy of your personal data before deletion.
            </p>
            <button
              onClick={handleDownloadData}
              disabled={downloading}
              className="w-full rounded-[14px] py-3.5 text-[13px] font-bold transition-all"
      ...
      {step === "confirm" && (
        <div className="px-5">
          <div className="rounded-[20px] p-6 text-center" style={{ background: "var(--bg-card)" }}>
            ...
            <div className="rounded-[14px] p-4 mb-4" style={{ background: "rgba(255,59,59,0.08)", border: "1px solid rgba(255,59,59,0.2)" }}>
            ...
            <label className="flex items-start gap-3 mb-6 cursor-pointer">
              <input
                ...
                className="mt-0.5 w-5 h-5 rounded accent-[#FF3B3B] flex-shrink-0"
              />
              <span className="text-[12px] font-medium" style={{ color: "var(--text-2)" }}>
                I understand that my account and all personal data will be permanently deleted after 30 days. This action cannot be undone.
              </span>
            </label>
            ...
            <button
              ...
              style={{
                background: confirmed ? "var(--danger, #FF3B3B)" : "var(--bg-elevated)",
            ...
            <button
              onClick={() => { setStep("info"); setConfirmed(false); }}
