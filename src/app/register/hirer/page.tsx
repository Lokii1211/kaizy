      ...
      <div className="px-5 py-5">
        ...
        {step < 3 && (
          <div className="flex gap-3 mt-8">
            ...
            <button onClick={() => step === 2 ? handleCompleteRegistration() : setStep(step + 1)}
                    disabled={submitting}
                    className="flex-1 rounded-[16px] py-3.5 text-[12px] font-black text-white text-center active:scale-[0.97] transition-transform disabled:opacity-60"
                    style={{ background: "var(--gradient-cta)", boxShadow: "var(--shadow-brand)" }}>
              {submitting ? "Registering..." : step === 2 ? "Complete Registration" : "Next →"}
            </button>
          </div>
        )}
      </div>
