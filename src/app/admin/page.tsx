      ...
      <div className="px-4 pt-4 pb-3" style={{ background: "linear-gradient(135deg, #1a1a2e 0%, #16213e 100%)" }}>
        <div className="flex justify-between items-center mb-3">
          ...
          <div className="flex gap-2">
            <button onClick={refresh} aria-label="Refresh data" className="w-9 h-9 rounded-full flex items-center justify-center active:scale-90"
                    style={{ background: "rgba(255,255,255,0.1)" }}>
              <span className="text-[16px]" style={{ animation: refreshing ? "spin 1s linear infinite" : "none" }}>🔄</span>
            </button>
            <Link href="/settings" aria-label="Settings" className="w-9 h-9 rounded-full flex items-center justify-center"
                  style={{ background: "rgba(255,255,255,0.1)" }}>
