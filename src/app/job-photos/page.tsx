  ...
  return (
    <div className="min-h-screen pb-20" style={{ background: "var(--bg-app)" }}>
      ...
      <div className="flex items-center gap-3 px-4 pt-4 pb-3">
        <Link href="/tracking" aria-label="Go back" className="w-9 h-9 rounded-full flex items-center justify-center active:scale-90"
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            {currentPhotos.map(photo => (
              <div key={photo.id} className="relative rounded-xl overflow-hidden" style={{ border: "1px solid var(--border-1)" }}>
                ...
                <button onClick={() => removePhoto(photo.id)} aria-label="Remove photo"
