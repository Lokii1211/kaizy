                ...
                return (
                  <div key={member.name} className="rounded-[16px] p-4" style={{ background: "var(--bg-card)" }}>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button aria-label="View worker profile" className="py-2 px-3 rounded-[12px] text-[10px] active:scale-95 transition-transform"
                              style={{ background: "var(--bg-surface)", color: "var(--text-2)" }}>👁️</button>
                      <button aria-label="Call worker" className="py-2 px-3 rounded-[12px] text-[10px] active:scale-95 transition-transform"
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-[16px] p-4" style={{ background: "var(--brand-tint)" }}>
              ...
              <div className="flex flex-wrap gap-1.5">
                {["📢 Promote skills", "🎯 Assign to projects", "📚 Upskill via KaizyLearn"].map(tip => (
