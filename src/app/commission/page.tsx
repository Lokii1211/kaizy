      ...
      <div className="px-5">
        ...
        {!loading && entries.length === 0 && (
          <div className="rounded-[20px] p-8 text-center" style={{ background: "var(--bg-card)" }}>
            ...
            <p className="text-[14px] font-bold" style={{ color: "var(--text-1)", fontFamily: "'Epilogue', sans-serif" }}>No commission data</p>
            <p className="text-[11px] font-medium mt-1" style={{ color: "var(--text-3)" }}>
              Commission entries will appear here after you complete jobs
            </p>
          </div>
        )}
