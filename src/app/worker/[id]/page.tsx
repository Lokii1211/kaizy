...
export default function WorkerProfilePage() {
  ...
  if (!worker) return (
    <div className="min-h-screen flex flex-col items-center justify-center px-5" style={{ background: "var(--bg-app)" }}>
      <div className="rounded-[24px] p-8 text-center max-w-xs w-full" style={{ background: "var(--bg-card)", boxShadow: "var(--shadow-card)" }}>
        ...
        <button onClick={() => router.back()}
                className="w-full rounded-[14px] py-3 text-[12px] font-bold active:scale-95 transition-all"
